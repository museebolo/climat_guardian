...
// import script
import findIpByName, { GetEspPosition, useFetchData, useLastData} from "@/lib/data";
...
export default function Page({params}: { params: any }) {
    ...
    return (
        <div className="flex w-full h-full min-w-[500px] flex-col gap-y-5 pt-2">
            ...
            <div className="flex flex-row gap-x-5">
                <div className="flex flex-col gap-y-3 w-1/2 ">
                    ...
                    <div className="flex flex-row p-5 border-2 border-alto-200 rounded-xl">
                ...
                <div className="flex flex-col gap-y-3 w-1/2 ">
                    <p className="text-xl ">
                        Average data ( From {date?.from ? format(date.from, "yyyy-MM-dd") : ""} to {date?.to ? format(date.to, "yyyy-MM-dd") : ""}
                        ) :</p>
                    <div className="flex flex-row p-5 border-2 border-alto-200 rounded-xl">
                        <PieChartTemperature data={temperature}/>
                        <PieChartHumidity data={humidity}/>
            ...
            <div className="flex justify-center border-alto-200 border-2 rounded-xl">
                <svg
