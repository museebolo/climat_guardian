...
export function ChartElement({data}: { data: avgData[] }) {
    ...
    return (
        <div>
            {message && (
                <div
                    className="animate-slide-in fixed right-5 top-5 z-50 flex items-center gap-2 rounded border-l-4 border-l-green-900 bg-green-50 p-4 text-green-900 shadow-lg dark:border-l-green-700 dark:bg-green-900 dark:text-green-50">
                    <ScanSearch/>{" "}
